---
layout: post
title:  자식테마를 이용한 워드프레스 테마 변경하기
excerpt: 워드프레스를 사용하다보면 테마를 변경할 일이 종종 생기곤 합니다. 이 때 테마를 변경하는 방법에는 어떤 것들이 있을까요? 여기서는 몇 가지 테마 변경 방법 중 하나인 자식테마(child theme)를 이용하는 방법을 소개합니다.
