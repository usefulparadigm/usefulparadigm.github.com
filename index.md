...
services: 
  - name: webdev
    ...
    description: 유스풀패러다임은 높은 생산성을 갖춘 웹 프레임워크인 <a href="http://rubyonrails.org/">루비온레일스</a>(Ruby on Rails)와 여러 오픈소스 도구들을 사용하여 고객 니즈에 부합하는 다양한 유형의 웹서비스를 빠르고 유연하게 구현합니다.
