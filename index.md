...
services: 
  - name: webdev
    ...
    description: 유스풀패러다임은 높은 생산성을 자랑하는 웹 프레임워크인 <a href="http://rubyonrails.org/">루비온레일스</a>(Ruby on Rails)를 중심으로 여러 오픈소스 도구들과 애자일(Agile) 웹개발 방법을 사용하여 사용성 높은 웹서비스를 만듭니다.
